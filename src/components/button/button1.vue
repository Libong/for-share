...
<template>
  <button :style="customStyle" :class="buttonClass" @click="animateButton">{{btnText}}</button>
</template>
...
.bubbly-button{
  ...
  &:before{
    ...
    top: -75%;
    background-image:
        radial-gradient(circle, #33798b 20%, transparent 20%),
  ...
  &:after{
    ...
    bottom: -75%;
    background-image:
        radial-gradient(circle, #0c4369 20%, transparent 20%),
