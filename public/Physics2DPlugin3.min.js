...
!function(n, e) {
    ...
    function s(n) {
        r = n || j(),
        d || (a = r.utils.getUnit, u = r.core.getStyleSaver, y = r.core.reverting || function() {}, d = 1)
    }
    function t(n, e, t, i, s) {
        ...
        this.p = e,
            ...
            this.vel = t || 0,
            this.v = this.vel / s,
            i || 0 === i ? (this.acc = i, this.a = this.acc / (s * s)) : this.acc = this.a = 0
    }
    var r,
        d,
        a,
            ...
            render: function render(n, e) {
                ...
                if (p._time || !y()) {
                    if (1 === v)
                        ...
                        for (o = a = (0 | (w *= u)) - d, a < 0 && (c.v = c.vel / u, l.v = l.vel / u, c.val = c.s, l.val = l.s, o = a = (e.step = 0) | w), r = w % 1 * v; a--;)
                            c.v += c.a,
                                l.v += l.a,
                                c.v *= v,
                                l.v *= v,
